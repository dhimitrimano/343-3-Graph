...
private:
  ...
  // if inVertex == "", searches innerGraph. else, searches inVertex's edges vector
  int getIndex(const string &inVertex, const string &find) const;

  // the graph. a vector holding all of the vertices
  vector<Vertex *> innerGraph;

  // are the graph's edges directional
  bool doubleEdge;
  ...
  // helper for dijkstra and prim. Really Useful
